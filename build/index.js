...
function builder(el, builderParams) {
  ...
  function addOneTimeHandler(target, eventName, handler) {
  ...
  function getEvents() {
    return [{ target: opener, name: 'click', handler: togglePanelIsOpen }, { target: panel, name: 'click', handler: selectTargetOption }, { target: select, name: 'click', handler: setFocusToOpener }, { target: panel, name: 'mouseover', handler: mouseoverEvent }, { target: panel, name: focusOutsidePanel, handler: scrollToFocused }, { target: select, name: 'change', handler: changeEvent }, { target: container, name: 'keydown', handler: keydownEvent }];
  }
